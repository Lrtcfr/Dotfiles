...
sudo apt-key -y add --keyserver hkp://keyserver.ubuntu.com:80 --recv-keys BBEBDCB318AD50EC6865090613B00F1FD2C19886 
...
rm sublime-text_build-3126_amd64.deb rm discord-0.0.1.deb
sh -c "$(wget https://raw.githubusercontent.com/robbyrussell/oh-my-zsh/master/tools/install.sh -O -)"

# Installation des fonts
git clone git@github.com:abertsch/Menlo-for-Powerline.git
cd Menlo-for-Powerline/
cp "Menlo for Powerline.ttf" ~/.fonts fc-cache -vf ~/.fonts